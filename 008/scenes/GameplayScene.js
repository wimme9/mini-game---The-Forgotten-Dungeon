...
export default class GameplayScene extends Phaser.Scene {
    ...
    init() {
        ...
        // --- ระบบจับเวลา ---
        this.timeLimit = 90; // ตั้งเวลาไว้ 90 วินาที (1 นาที 30 วินาที)
        this.timerText = null;
    ...
    preload() {
        ...
        this.load.image('bookAsset', 'sprite/book.png'); // เช็คไฟล์ในโฟลเดอร์ให้เป็นพิมพ์เล็กด้วยนะครับ
        this.load.image('dragonAsset', 'sprite/dragon.png');
        this.load.image('npcAsset', 'sprite/npc.png');
        
        // แก้ไขชื่อไฟล์โคมไฟให้ไม่มีช่องว่างและเป็นตัวพิมพ์เล็ก (แก้ปัญหา GitHub หาไฟล์ไม่เจอ)
        ...
        this.load.image('chestStatic', 'sprite/Wooden Chest 2 - frame  00.png'); // ถ้าอกล่องมีปัญหาก็ควรแก้ให้เป็นพิมพ์เล็กแบบเดียวกัน
    ...
    triggerVictoryScene() {
        ...
        // เปลี่ยน Scene ไปหน้า Menuwin (ลบโค้ด UI เดิมที่ซ้ำซ้อนออกแล้ว)
